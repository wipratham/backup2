...
class FeatureExtractor:
    """
    A class to extract features using a pre-trained model (ViT or EfficientNet) and visualize them in TensorBoard.

    Attributes:
        model_name (str): Name of the pre-trained model (ViT or EfficientNet).
    ...
    def process_images(self):
        ...
        # Load the pretrained model (can be ViT or EfficientNet)
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Extract features using a pre-trained model (ViT or EfficientNet).")
    parser.add_argument("--model_name", type=str, default="efficientnet_b0", help="Name of the pre-trained model (ViT or EfficientNet).")
