...
class FeatureExtractor:
    ...
    def load_model(self):
        ...
        if self.model_name == "resnet50":
          ...
          model = models.resnet110(pretrained=True)
        elif self.model_name == "resnet152":
          model = models.resnet152(pretrained=True)
        elif self.model_name == "resnet164":
          model = models.resnet164(pretrained=True)
        elif self.model_name == "resnet1202":
          model = models.resnet1202(pretrained=True)
        else:
          raise ValueError("Invalid model_name. Supported models: resnet50, resnet101, resnet110, resnet152, resnet164, resnet1202")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Extract features using a pre-trained model (ViT or ResNet50).")
    parser.add_argument("--model_name", type=str, default="resnet50", help="Name of the pre-trained model (ViT or ResNet50).")
